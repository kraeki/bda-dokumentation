...
Das Projekt ist in folgende vier Phasen unterteilt:

\begin{description}
    \item[Recherchephase] Was beinhaltet diese? Bla bal bal 
    \item[Prototypphase]
    \item[Realisierungsphase]
    \item[Abschlussphase]
\end{description}

Was gibts für Meilensteine?
\begin{description}
    \item[MS1, bla] Was wird erwartet, was schliesst er ab, was leitet er ein?
    \item[MS2]
    \item[MS3]
    \item[MS4]
\end{description}
...
\subsection{Bericht Meilenstein 1}
\subsection{Bericht Meilenstein 2}
\subsection{Bericht Meilenstein 3}
\subsection{Bericht Meilenstein 4}
